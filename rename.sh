...
read -p "Galaxy namespace (e.g., anylinq): " NAMESPACE
...
sed -i "s/anylinq/$NAMESPACE/g" meta/main.yml
...
echo ""
echo "Note:"
echo "This script does not replace AnyLinQ-specific information, so check the meta/main.yml and README.md for additional updates."
